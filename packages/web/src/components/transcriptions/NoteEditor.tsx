      ...
      <div className="flex flex-wrap items-center justify-between gap-2 px-4 md:px-6 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
        ...
        <div className="flex items-center gap-3">
          ...
          {onClose && (
            <button
              onClick={onClose}
              className="p-3 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors rounded min-w-[44px] min-h-[44px] flex items-center justify-center"
            >
...
function SuggestionChip({
  ...
  return (
    <div className="flex items-center gap-1.5 px-3 py-2 bg-white dark:bg-gray-800 border border-indigo-200 dark:border-indigo-700 rounded-lg text-xs min-h-[44px]">
      <button
        onClick={onApply}
      ...
      <button
        onClick={onDismiss}
        className="ml-1 p-1.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors"
      >
