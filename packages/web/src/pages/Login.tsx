        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-6">
            ...
            <p className="text-navy-300 text-lg max-w-md font-body leading-relaxed">
              Secure, intuitive electronic health records designed for modern healthcare practices.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-clinical-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-12">
            ...
            <span className="font-display font-bold text-xl text-navy-900">MedChart</span>
          </div>
