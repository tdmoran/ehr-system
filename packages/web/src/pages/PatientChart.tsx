...
export default function PatientChart() {
  ...
  const isProvider = user?.role === 'provider' || user?.role === 'admin' || user?.role === 'nurse';
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                {isProvider && (
                  <button
                    onClick={() => navigate(`/transcriptions/new?patientId=${patient.id}`)}
                    className="btn-primary bg-indigo-600 hover:bg-indigo-700 text-sm col-span-2 inline-flex items-center justify-center gap-2"
                  >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-3">
          ...
          <div className="animate-fade-in">
            ...
            {activeTab === 'ai-visits' && (
              <PatientTranscriptionHistory patientId={patient.id} />
            )}
